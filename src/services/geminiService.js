// ============================================================================
// SERVIÇO DE ASSISTENTE VIRTUAL IA COM GEMINI & RAG (MONTE CARMO SHOPPING)
// ============================================================================
...
// Formata o Catálogo de Lojas e Filmes para o contexto do RAG
...
export const geminiService = {
  async askAssistant(userMessage, chatHistory = []) {
    if (!GEMINI_API_KEY) {
    ...
    try {
      ...
      console.warn('Fallback RAG local:', error.message);
      return this.localRagFallback(userMessage);
    }
  },
